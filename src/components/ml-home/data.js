...
export const VOLUMES = [
  ...
  { n: '卷五', title: '应用 AI 与前沿', range: '43–67 章 · 含 AI for Math', status: 'plan', statusLabel: '规划中', desc: '把数学变成理解和使用现代智能系统的工具：优化、深度学习、Transformer、生成模型、强化学习、可信 AI、随机分析、范畴论等前沿章。' },
  { n: '卷六', title: '工程与系统', range: '68–75 章', status: 'plan', statusLabel: '规划中', desc: '前五卷回答「数学是什么」，卷六回答「数学在真实机器里怎么落地」。按依赖拓扑编排：电（68 电子电路）→ 算（69 数字系统、70 计算机系统）→ 机（71 机械工程、72 机电系统）→ 声（73 音频声学、74 语音音频）→ 画（75 图像视频）——只引用、不发明新数学的落地卷。' },
];
