...
export const VOLUMES = [
  ...
  { n: '卷六', title: '工程与系统', range: '68–75 章', status: 'plan', statusLabel: '规划中', desc: '前五卷回答「数学是什么」，卷六回答「数学在真实机器里怎么落地」：声（音频声学）、画（图形学）、电（电子电路）、算（计算机系统）、机（机器人运动）——只引用、不发明新数学的落地卷。' },
];
