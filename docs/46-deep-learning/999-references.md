---
title: 深度学习基础 · 参考资料
description: 第 46 章涉及的核心论文、原著与延伸阅读一览。
volume: 5
layer: L7
track:
...
# @venue: Nature
# @tag: 论文
# @desc: 链式法则逐层传误差：多层网络真正能训练的开端。
# @page: https://en.wikipedia.org/wiki/Backpropagation
```

```paper
# @title: Deep Residual Learning（ResNet）
# @authors: Kaiming He 等（微软亚洲研究院）
# @year: 2015
# @venue: arXiv:1511.06434 (CVPR 2016)
# @tag: 论文
...
```paper
# @title: Dropout（随机失活）
# @authors: Srivastava, Hinton 等
# @year: 2014
# @venue: JMLR（思想源于 2012 年 arXiv 预印本）
# @tag: 论文
